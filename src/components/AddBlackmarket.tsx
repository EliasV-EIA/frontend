...
const AddBlackmarket = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    axios
      .post('https://backend-drf6.onrender.com/blackmarket', formData) // Make sure to adjust URL
      .then(() => {
  ...
  return (
    <div>
      <h2>Add a New Black market transaction</h2>
